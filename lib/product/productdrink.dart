...
class ProductDrink extends StatefulWidget {
  var _drink;
  ProductDrink(this._drink);
  @override
  State<ProductDrink> createState() => _ProductDrinkState();
}

class _ProductDrinkState extends State<ProductDrink> {
  ...
  Future addtoCart() async {
    ...
    return _collectionRef
        ...
        .collection("items")
        .doc(widget._drink["id"])
        .set({
      "id": widget._drink["id"],
      "name": widget._drink["name"],
      "price": widget._drink["price"],
      "images": widget._drink["image"],
      "market": widget._drink["market"],
      "time": "",
      "status": "กำลังดำเนินการ",
      "quantity": '${count.toString()}',
      "sumprice": widget._drink["price"],
  ...
  Widget build(BuildContext context) {
    int TT = int.parse('${widget._drink['price'].toString()}') * count;
    return Scaffold(
        ...
        actions: [
          StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .collection("items")
                .where("name", isEqualTo: widget._drink['name'])
                .snapshots(),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Center(
              child: Container(
                width: double.infinity,
                child: Image.network(widget._drink['image'].toString(),
