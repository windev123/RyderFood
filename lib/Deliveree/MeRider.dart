...
import 'package:flutter_application_3/Deliveree/ChangePassRider.dart';
import 'package:flutter_application_3/Deliveree/ContactScreenRider.dart';
import 'package:flutter_application_3/Deliveree/Edit_profileRider.dart';
...
class MeRider extends StatefulWidget {
  const MeRider({Key? key}) : super(key: key);

  @override
  State<MeRider> createState() => _MeRiderState();
}

class _MeRiderState extends State<MeRider> {
  Future _getDataFromDatabase() async {
    await FirebaseFirestore.instance
        .collection("user-rider-form-data")
        ...
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
                fit: BoxFit.cover,
                image: NetworkImage(
                    "https://i.pinimg.com/originals/55/f1/1d/55f11d17f756a3c145c66bd696e9073e.jpg")),
          ),
        ),
        SizedBox(
          height: 0,
  ...
  updateData() {
    CollectionReference _collectionRef =
        FirebaseFirestore.instance.collection("user-rider-form-data");
