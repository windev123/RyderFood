...
class EditCandy extends StatefulWidget {
  const EditCandy({Key? key}) : super(key: key);
  @override
  State<EditCandy> createState() => _EditCandyState();
}

class _EditCandyState extends State<EditCandy> {
  ...
  final CollectionReference _products =
      FirebaseFirestore.instance.collection("candy");
            ...
            Wrap(
              children: [
                                                        ...
                                                        onPressed: () async {
                                                          showDialog(
                                                              ...
                                                              builder: (_) =>
                                                                  AlertDialog(
                                                                    title: Text(
                                                                        "คุณแน่ใจจะแก้ไขข้อมูลขนม?"),
                                                                    content: Text(
                                                                        "ถ้าแก้ไขข้อมูลขนมแล้วข้อมูลเดิมจะหายไป!"),
                                                                    actions: [
                                                                      MaterialButton(
                                                                        onPressed:
                                                                            () async =>
                                                                          ...
                                                                          ScaffoldMessenger.of(context)
                                                                            ...
                                                                            SnackBar(
                                                                              ...
                                                                              content: Text(
                                                                                "แก้ไขข้อมูลขนมแล้วครับ กรุณาโปรดไปยังหน้าอื่นแล้วกลับมาหน้านี้อีกครั้ง",
                                                                                style: TextStyle(
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          ScaffoldMessenger.of(context)
                                                                            ...
                                                                            SnackBar(
                                                                              backgroundColor: Color.fromARGB(255, 0, 0, 0),
                                                                              content: Text(
                                                                                "ลบขนมแล้วครับ กรุณาโปรดไปยังหน้าอื่นแล้วกลับมาหน้านี้อีกครั้ง",
                                                                                style: TextStyle(
                                                                                  color: Color.fromARGB(255, 255, 255, 255),
                                                                                ),
                                                                              ),
                ...
                Container(
                  height: 50,
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(297, 0, 0, 0),
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.pushReplacement(context,
                            MaterialPageRoute(builder: (_) => Candy()));
                      },
                      child: Text('เพิ่มขนม'),
                    ),
                  ),
