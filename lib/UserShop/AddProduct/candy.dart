...
import 'package:flutter_application_3/UserShop/AddProduct/candy_image.dart';
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(labelText: 'ราคา:ขนม'),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'กรุณาป้อนราคา:ขนม';
                            }
                            return null;
                          },
                          onSaved: (value) {
